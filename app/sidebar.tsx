...
const menus: Menu[] = [
  ...
  { href: '/installments', labelKey: 'menu.installments', icon: '💳', roles: ['owner', 'manager', 'cashier', 'accountant'] },
  ...
  { href: '/reports', labelKey: 'menu.reports', icon: '📊', roles: ['owner', 'manager', 'accountant'] },
